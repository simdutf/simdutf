...
private:
  ...
  run_utf8_length_from_utf16be(const simdutf::implementation &implementation,
                               size_t iterations);
  void
  run_utf8_length_from_utf16le_with_replacement(const simdutf::implementation &implementation,
                               size_t iterations);
  void
  run_utf8_length_from_utf16be_with_replacement(const simdutf::implementation &implementation,
                               size_t iterations);
