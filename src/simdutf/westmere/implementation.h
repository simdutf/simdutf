...
public:
  ...
  simdutf_warn_unused size_t utf8length_from_utf16(const char16_t * input, size_t length) const noexcept;
  simdutf_warn_unused size_t utf16length_from_utf8(const char * input, size_t length) const noexcept;
};
