...
std::pair<const char32_t*, char*> avx2_convert_utf32_to_latin1(const char32_t* buf, size_t len, char* latin1_output) {
    ...
    for (size_t i = 0; i < rounded_len; i += 16) {
        ...
        __m256i shuffled1 = _mm256_shuffle_epi8(in1, shufmask);
        _mm_storeu_si128((__m128i*)latin1_output, _mm256_castsi256_si128(shuffled1));
        _mm_storeu_si128((__m128i*)(latin1_output + 4), _mm256_extracti128_si256(shuffled1, 1));
        
        __m256i shuffled2 = _mm256_shuffle_epi8(in2, shufmask);
        _mm_storeu_si128((__m128i*)(latin1_output + 8), _mm256_castsi256_si128(shuffled2));
        // _mm_storeu_si128((__m128i*)(latin1_output + 12), _mm256_extracti128_si256(shuffled2, 1));
        *reinterpret_cast<uint32_t*>(latin1_output + 12) = _mm_cvtsi128_si32(_mm256_extracti128_si256(shuffled2, 1));
