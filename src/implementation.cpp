...
public:
  ...
  simdutf_warn_unused std::vector<encoding_type> op_autodetect_encoding(const char * input, size_t length) const noexcept {
    return set_best()->op_autodetect_encoding(input, length);
  }
...
public:
  simdutf_warn_unused std::vector<encoding_type> op_autodetect_encoding(const char *, size_t) const noexcept {
...
simdutf_warn_unused std::vector<simdutf::encoding_type> op_autodetect_encoding(const char * buf, size_t length) noexcept {
  return active_implementation->op_autodetect_encoding(buf, length);
}
