...
simdutf_warn_unused size_t implementation::binary_length_from_base64(
    const char *input, size_t length, base64_options options) const noexcept {
  return scalar::base64::binary_length_from_base64(input, length, options);
}
...
simdutf_warn_unused size_t binary_length_from_base64(
    const char *input, size_t length, base64_options options) noexcept {
  return get_default_implementation()->binary_length_from_base64(input, length,
                                                                 options);
}

simdutf_warn_unused size_t binary_length_from_base64(
    const char16_t *input, size_t length, base64_options options) noexcept {
  return get_default_implementation()->binary_length_from_base64(input, length,
                                                                 options);
}
