...
TEST_LOOP(trials, issue_446) {
    ...
    const auto r = implementation.convert_utf8_to_latin1_with_errors((const char *) crash,
                                                               crash_len,
                                                               output.data());
