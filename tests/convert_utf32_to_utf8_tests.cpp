...
TEST(fuzz_7cfce3ad85893b9ca6431be21591ba8b1aa93713) {
  const uint8_t input[] =
      "\x13`"
      "\x00\x00\x00\x00\x00\x00\x00\x00\x00\x80\x00\x00\x00\x00\x00\x00\x00\x80"
      "\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00"
      "\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00"
      "\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00"
      "\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00"
      "\x00'"
      "\x00\x00\x00\x80\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00"
      "\xff\x00\x00\x00";

  const char32_t *utf32 = reinterpret_cast<const char32_t *>(input);
  const size_t size = sizeof(input) / sizeof(char32_t);
  std::vector<char> utf8;
  utf8.resize(size * 4);

  const size_t utf8_length =
      implementation.convert_utf32_to_utf8(utf32, size, utf8.data());
