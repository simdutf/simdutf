...
#
# This script reads the output.txt file generated by the shortbench benchmark
...
# 2. Execute this script: python scripts/shortinputplots.py
#
...
if __name__ == '__main__':
    functions = parse_output_file('output.txt')
