...
public:
   ...
   * @return the number of char16_t words required to encode the UTF-8 string as UTF-16
   */
  simdutf_warn_unused virtual size_t utf16length_from_utf8(const char * input, size_t length) const noexcept = 0;
   ...
   * @return the number of bytes required to encode the UTF-16 string as UTF-8
   */
  simdutf_warn_unused virtual size_t utf8length_from_utf16(const char16_t * input, size_t length) const noexcept = 0;
