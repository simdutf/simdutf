...
1. Pull the library in a directory
   ```
   wget https://github.com/simdutf/simdutf/releases/download/v8.1.0/singleheader.zip
...
https://github.com/simdutf/simdutf/releases/download/v8.1.0/singleheader.zip
