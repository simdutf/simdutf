...
1. Pull the library in a directory
   ```
   wget https://github.com/simdutf/simdutf/releases/download/v5.3.0/singleheader.zip
...
https://github.com/simdutf/simdutf/releases/download/v5.3.0/singleheader.zip
