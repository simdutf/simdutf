...
1. Pull the library in a directory
   ```
   wget https://github.com/simdutf/simdutf/releases/download/v5.2.5/singleheader.zip
...
https://github.com/simdutf/simdutf/releases/download/v5.2.5/singleheader.zip
